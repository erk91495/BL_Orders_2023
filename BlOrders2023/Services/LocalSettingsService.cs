...
public class LocalSettingsService : ILocalSettingsService
{
    ...
    private void WriteDefaultLocalSettings()
    {
        ...
        SaveSetting(LocalSettingsKeys.DBConnectionString, "Data Source=BL4;Initial Catalog=New_BL_Orders;User ID=;Trust Server Certificate=True;Authentication=ActiveDirectoryIntegrated");
    }
