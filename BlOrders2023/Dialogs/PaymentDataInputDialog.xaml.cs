...
public sealed partial class PaymentDataInputDialog : ContentDialog, INotifyPropertyChanged
{
    #region Fields
    ...
    #region Constructors
    public PaymentDataInputDialog(IEnumerable<Order> unpaidOrders, IList<PaymentMethod> paymentMethods)
    {
